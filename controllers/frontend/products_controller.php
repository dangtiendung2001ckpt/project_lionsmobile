...
class ProductsController extends ShowData
{
    ...
    function homes()
    {
        ...
        $products=$this->getSomeProduct('product','product_id','ASC',$limit,$offset,'defaults',1);
        $totalpage = $this->row('product','defaults',1);
