...
function setupTinyMCE() {
    $('textarea.tinymce').tinymce({
        ...
        // General options
        theme: "advanced",
        plugins: "autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,ity,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist",
